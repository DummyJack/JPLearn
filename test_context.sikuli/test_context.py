...
class ContextTest(unittest.TestCase):
    ...
    pattern_song = Pattern("fifty_song.png").exact()
    pattern_correct = Pattern("correct_btn.png").similar(0.94)

    def setUp(self):
        click(Pattern("fifty_words_btn.png").targetOffset(30,4)) # 開啟五十音介面
        wait(Pattern("fifty_view.png").similar(0.99))
    ...
    def test_fifity_words(self):
        try:
            ...
            for i in fifty_words_btn:
                pattern_fifty_words = Pattern(i).similar(0.99)
